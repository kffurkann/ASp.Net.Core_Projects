...
namespace RazorPagesProject.Repository
{
    public class MockEmployeeRepository : IEmployeeRepository
    {
            ...
            _employeeList = new List<Employee>()
        {
            ...
            new Employee { Id = 5, Name="Ahmet Yılmaz", Email = "ahmetyilmaz@gmailc.com", Photo = "1.jpg", Deparment = "Muhasebe"},
            new Employee { Id = 6, Name="Hasan Cengiz", Email = "hasancengiz@gmailc.com", Photo = "2.jpg", Deparment = "Muhasebe"},
            new Employee { Id = 7, Name="Canan Turan", Email = "cananturan@gmailc.com", Photo = "3.jpg", Deparment = "Muhasebe"},
            new Employee { Id = 8, Name="Volkan Yükselen", Email = "volkanyukselen@gmailc.com", Photo = "4.jpg", Deparment = "Muhasebe"}
        };
        }
